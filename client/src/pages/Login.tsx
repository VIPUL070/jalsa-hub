...
const Login = () => {
  ...
  const { login, verifyOtp } = useContext(AuthContext) as AuthContextType;
  ...
  return (
    <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500">Sign in to your JalsaHub account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-gray-900 text-white cursor-pointer font-bold py-3 rounded-lg hover:bg-black focus:ring-4 focus:ring-gray-200 transition shadow-md"
        >
          {loading
            ? "Processing..."
            : showOTP
